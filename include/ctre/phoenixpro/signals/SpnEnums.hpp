 ...
 *         Choose FusedCANcoder and Talon FX will fuse another CANcoder's
 *         information with the internal rotor, which provides the best possible
 *         position and velocity for accuracy and bandwidth (note this requires
 *         setting FeedbackRemoteSensorID).  FusedCANcoder was developed for
