...
#if __has_include("ctre/phoenix/export.h")
...
namespace phoenix {
    ...
    public:
        ...
        /**
         * \brief The given network/CAN bus is invalid. Verify that any status signals
         *        provided are on the same network and that the network is present.
         */
        ...
        /**
         * \brief The schema for the logged user signal is invalid or missing. Ensure
         *        that the schema is written before the user signal.
         */
        static constexpr int MissingSchema = -10043;
        ...
        constexpr const char *GetName() const
        {
            switch (value) {
                ...
                case -10043: return "MissingSchema";
                default:
        ...
        constexpr const char *GetDescription() const
        {
            switch (value) {
                ...
                case -10001: return "The given network/CAN bus is invalid. Verify that any status signals provided are on the same network and that the network is present.";
                ...
                case -10043: return "The schema for the logged user signal is invalid or missing. Ensure that the schema is written before the user signal.";
                default:
                    /* because we return const char*, we cannot create
                        * a string with the status error code */
